...
namespace Nyous.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        // Definir uma variável para percorrer nossos métodos com as configurações obtidas no appsettings.json
        private IConfiguration _config;

        // Definir um método construtor para poder passar essas configs
